...
export const BOMBERMAN_MAPS: BombermanMapDefinition[] = [
  ...
  },
  {
    ...
    crateModulo: 6,
    crateThreshold: 3,
    solidTiles: ["6,3", "8,3", "6,7", "8,7", "4,4", "10,6"],
    emptyTiles: ["7,3", "7,4", "7,5", "7,6", "7,7", "3,5", "11,5"],
    spawnPoints: DEFAULT_SPAWN_POINTS,
  },
  {
    id: "four-corners",
    ...
    crateModulo: 5,
    crateThreshold: 2,
    solidTiles: ["7,3", "7,7", "5,5", "9,5"],
    emptyTiles: ["3,1", "11,1", "3,9", "11,9", "7,5", "6,5", "8,5"],
    spawnPoints: DEFAULT_SPAWN_POINTS,
  },
  {
    id: "maze-garden",
    ...
    crateModulo: 7,
    crateThreshold: 3,
    solidTiles: ["4,2", "10,2", "4,4", "10,4", "4,6", "10,6", "4,8", "10,8", "7,5"],
    emptyTiles: ["2,2", "3,3", "11,3", "12,2", "3,7", "2,8", "11,7", "12,8", "6,5", "8,5"],
    spawnPoints: DEFAULT_SPAWN_POINTS,
  },
  {
    id: "power-core",
    ...
    crateModulo: 8,
    crateThreshold: 3,
    solidTiles: ["6,4", "8,4", "6,6", "8,6"],
    emptyTiles: ["6,5", "7,5", "8,5", "7,4", "7,6", "5,5", "9,5"],
    spawnPoints: DEFAULT_SPAWN_POINTS,
  },
  {
    id: "rush-lane",
